...
class _PhieuFormScreenState extends State<PhieuFormScreen> {
  ...
  useVnptSignature: true,
    ...
    try {
      ...
      final r = await hisPro.post('Mps${p.code.replaceAll("Mps", "")}', 'Save', {
        'TreatmentCode': treatmentCode,
    ...
    // v2.58.0: Clear draft nếu save thĂ nh công
    if (success) {
      try {
