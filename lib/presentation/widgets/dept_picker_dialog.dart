  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        // v3.0.174: Bỏ card nổi bật "Phòng thử thuật HSCC" ở trên cùng
        // - BS yêu cầu bỏ gim ở appbar (dept picker mở từ appbar)
        // - Đã có sẵn ở Tiện ích tab + Drawer shortcut (cũng đã bỏ)
        // - HSCC = khoa 22, user chọn qua list "— KHOA —" bên dưới (vẫn còn entry HSCC)
        const Padding(
