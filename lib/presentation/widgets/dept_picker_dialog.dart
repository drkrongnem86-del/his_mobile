  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        // v3.0.176: XÓA Card nổi bật "Phòng thử thuật HSCC" ở trên cùng
        // - BS yêu cầu: tile đã có ở Drawer, không cần ghim ở dropdown khoa
        // - User có thể truy cập từ: Drawer → "Phòng thử thuật HSCC" → mở ProcedureRoom
        const Padding(
