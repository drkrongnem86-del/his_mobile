...
android {
    ...
    defaultConfig {
        ...
        // v3.0.183: Removed ndk.abiFilters - conflict voi splits.abi khi build --split-per-abi
        // ABI arm64-v8a duoc set qua splits.abi block ben duoi (chi enable khi build APK, khong enable AAB)
    }
    ...
    // v3.0.183: ABI splits cho APK (arm64-v8a only, Samsung A17) - tuong thich --split-per-abi
    // Chi enable khi build APK (assemble*), KHONG enable khi build AAB (bundle*)
    splits {
        abi {
